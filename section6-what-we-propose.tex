...
The design isn't firmly tied to any of the tools used to build it.
    Easily embeddable ECMAScript engines\footnote{The library DukTape is deisgned for this type of use. \url{https://duktape.org/}} combined with tools to manipulate\footnote{Thge tool "Babel.JS" can "downgrade" newer JavaScript proframs for older interpreters. \url{https://babeljs.io/}} the compiled \lstinline{.js} would allow the approach to be used on other platforms.
